     ...
     messages: [
       {
         role: 'user',
         content: `
         сделай этот текст чётким и кратким примером если написано iphone 11 128гб new to
         а если он сам по себе такой четкий например iphone 11, tv, playstation оставить 
...
добавь / к ответу и пиши там краткий обзор стоит ли сколько % например 100 это отлично нужно брать а 50 % это нужно хорошенько  подумать  или 
